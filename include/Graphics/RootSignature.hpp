...
namespace Eternal
{
	namespace Graphics
	{
		...
		{
			ROOT_SIGNATURE_ACCESS_VERTEX = 0,
			ROOT_SIGNATURE_ACCESS_HULL,
			ROOT_SIGNATURE_ACCESS_DOMAIN,
			ROOT_SIGNATURE_ACCESS_GEOMETRY,
			ROOT_SIGNATURE_ACCESS_PIXEL,
			ROOT_SIGNATURE_ACCESS_COMPUTE,
			ROOT_SIGNATURE_ACCESS_AMPLIFICATION,
			ROOT_SIGNATURE_ACCESS_MESH,
			ROOT_SIGNATURE_ACCESS_COUNT,
			ROOT_SIGNATURE_ACCESS_INVALID = ROOT_SIGNATURE_ACCESS_COUNT,
			ROOT_SIGNATURE_ACCESS_RAYTRACING = ROOT_SIGNATURE_ACCESS_COMPUTE,
			ROOT_SIGNATURE_ACCESS_COMPUTE_RAYTRACING = ROOT_SIGNATURE_ACCESS_COMPUTE
		};
		...
		enum class RootSignatureParameterType
		{
			...
			ROOT_SIGNATURE_PARAMETER_RAYTRACING_ACCELERATION_STRUCTURE,
		...
		protected:
			...
			virtual DescriptorTable* _CreateSubDescriptorTable(_In_ GraphicsContext& InContext, _In_ uint32_t InSubDescriptorTableIndex, _In_ const RootSignatureDescriptorTable& InRootSignatureDescriptorTable) const;
