...
namespace Eternal
{
	...
	namespace Graphics
	{
		...
		enum class D3D12ShaderCompilerType
		{
			...
			, D3D12_SHADER_COMPILER_TYPE_DEFAULT = D3D12_SHADER_COMPILER_TYPE_FXC
#else
			, D3D12_SHADER_COMPILER_TYPE_DEFAULT = D3D12_SHADER_COMPILER_TYPE_DXC
#endif
		};
		...
		struct ShaderCreateInformation
		{
			...
			D3D12ShaderCompilerType D3D12CompilerPreference	= D3D12ShaderCompilerType::D3D12_SHADER_COMPILER_TYPE_DEFAULT;
			string Name;
			string FileName;
